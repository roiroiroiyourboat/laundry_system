...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 23, 2024 at 06:45 PM
...
INSERT INTO `service_request` (`request_id`, `customer_id`, `customer_name`, `contact_number`, `service_id`, `laundry_service_option`, `category_id`, `laundry_category_option`, `quantity`, `weight`, `price`, `request_date`, `service_request_datetime`, `order_status`) VALUES
(586, 386, 'denise', '00000000000', 1, 'Wash/Dry/Fold', 2, 'Bedsheet/Table Cloths/Curtain', 1, 5, 55.00, '2024-08-27', '2024-08-24 00:44:20', 'completed'),
(587, 386, 'denise', '00000000000', 2, 'Wash/Dry/Press', 1, 'Clothes/Table Napkin/Pillowcase', 1, 5, 80.00, '2024-08-27', '2024-08-24 00:44:20', 'completed');
...
INSERT INTO `settings` (`settings_id`, `min_kilos`, `max_kilos`, `delivery_day`) VALUES
(1, 5, 20, 3);
...
CREATE TABLE `transaction` (
  ...
  `pickup_fee` decimal(65,2) NOT NULL,
...
INSERT INTO `transaction` (`transaction_id`, `request_id`, `customer_id`, `user_id`, `service_option_id`, `service_option_name`, `laundry_cycle`, `customer_address`, `total_amount`, `delivery_fee`, `pickup_fee`, `rush_fee`, `amount_tendered`, `money_change`) VALUES
(370, 586, 386, 0, 1, 'Delivery', 'Rush', '', 750.00, 50.00, 0.00, 25.00, 800.00, 50.00),
(371, 587, 386, 0, 1, 'Delivery', 'Rush', '', 750.00, 50.00, 0.00, 25.00, 800.00, 50.00);
...
--
ALTER TABLE `customer`
  MODIFY `customer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=387;
...
--
ALTER TABLE `service_request`
  MODIFY `request_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=588;
...
--
ALTER TABLE `transaction`
  MODIFY `transaction_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=372;
