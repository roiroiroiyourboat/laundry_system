    ...
    <section class="home" id="home">
        ...
        <div class="form_container" id="form_container">
                <div class = "login_form">
                    ...
                    <form action="/laundry_system/main/homepage/configs/login_form" method="post">
                        <div class="row">
                            <div class="col">
            ...
            <div class="service_req_container">
                <form method="post" class="form-container" id="form-service">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <label for="form-label"><b>Pick-up Fee</b></label>
                            <input type="number" class="form-control" id="pickup_fee" name="pickup_fee" 
                            autocomplete="off" readonly>
                        </div>
                    </div>
